...
namespace _Pet
{
    public class SoundManager : MonoBehaviour
    {
        ...
        public List<Sound> backgrounds;
        public Sound AdTimeCount;
        public Sound AdTimeOut;

        public Sound playButton;
        public Sound reTryButton;
        public Sound selectButton;
        ...
        public void PlaySound(Sound sound, bool isSpecialSound = false, bool loop = false, bool autoScaleVolume = true, float maxVolumeScale = 1f)
        {
            if (sound == null || sound.clip == null)
                return;
            StartCoroutine(CRPlaySound(sound, isSpecialSound, loop, autoScaleVolume, maxVolumeScale));
        }
        public void StopSound(bool isSpecialSound = false)
        {
            if (specialSfxSource)
            {
                var src = specialSfxSource;
                src.Stop();
            }

        }
        IEnumerator CRPlaySound(Sound sound,  bool isSpecialSound = false, bool loop = false, bool autoScaleVolume = true, float maxVolumeScale = 1f)
        {
            yield return null;
        ...
        public void PlayMusic(Sound music, bool loop = true)
        {
            if (music == null || music.clip == null)
                return;
            StartCoroutine(CR_PlayMusic(music, loop));
        }
        IEnumerator CR_PlayMusic(Sound music, bool loop = true)
        {
            yield return null;
