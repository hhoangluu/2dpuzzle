        ...
        void OnSceneGUI()
        {
            ...
            if (WSpawner)
            {
               ...
               // EditorUtility.SetSelectedRenderState(WSpawner.GetComponent<MeshRenderer>(), EditorSelectedRenderState.Hidden);
                ...
                var fmh_1363_25_638770508486345936 = Quaternion.identity; newHandlePoint = (lTransform.position - Handles.FreeMoveHandle(
                ...
                var fmh_1402_91_638770508486370634 = Quaternion.identity; Vector3 newFreeHandlePoint = (Handles.FreeMoveHandle(lTransform.position,
